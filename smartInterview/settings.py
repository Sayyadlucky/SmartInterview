...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'smartInterviewApp.apps.SmartInterviewAppConfig',
    'angular',
    'storages',
]
...
LIVE_SELFIE_VERIFICATION_ENABLED = env_bool('LIVE_SELFIE_VERIFICATION_ENABLED', default=True)
LIVE_SELFIE_FACE_MATCH_PROVIDER = os.getenv('LIVE_SELFIE_FACE_MATCH_PROVIDER', 'local_face_recognition').strip() or 'local_face_recognition'
LIVE_SELFIE_FACE_MATCH_THRESHOLD = float(os.getenv('LIVE_SELFIE_FACE_MATCH_THRESHOLD', '0.62'))
LIVE_SELFIE_FACE_VERIFY_TIMEOUT_SECONDS = int(os.getenv('LIVE_SELFIE_FACE_VERIFY_TIMEOUT_SECONDS', '20'))
...
RESUME_AI_LEARNING_ENABLED = env_bool('RESUME_AI_LEARNING_ENABLED', default=True)
RESUME_AI_MIN_PROMOTION_SOURCE_COUNT = int(os.getenv('RESUME_AI_MIN_PROMOTION_SOURCE_COUNT', '3'))
RESUME_AI_MIN_CONFIDENCE_TO_USE = float(os.getenv('RESUME_AI_MIN_CONFIDENCE_TO_USE', '0.72'))
...
INTERVIEW_BLUEPRINT_OPENAI_TIMEOUT_SECONDS = int(os.getenv('INTERVIEW_BLUEPRINT_OPENAI_TIMEOUT_SECONDS', '60'))
