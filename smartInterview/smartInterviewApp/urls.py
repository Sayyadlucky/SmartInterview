...
urlpatterns = [
    ...
    path('candidate/refresh-resume-details/', commonViews.refreshCandidateResumeDetails, name='candidate-refresh-resume-details'),
    ...
    path('candidate/save-vacancy/', commonViews.saveVacancy, name='candidate-save-vacancy'),
    path('candidate/unsave-vacancy/', commonViews.unsaveVacancy, name='candidate-unsave-vacancy'),
