...
KNOWLEDGE_ENTRIES = [
    ...
    },
    {
        ...
        'steps': ['Open Candidates or use the dashboard Assign Candidate action.', 'Create or find the candidate profile.', 'Search and select the target Role by title or role ID.', 'Select the recruiter or hiring owner for follow-up.', 'Save with Assign Candidate.', 'Review the candidate under that role in Candidate Management or the role pipeline.'],
        'priority': 25,
    },
    {
        'category': 'candidate',
